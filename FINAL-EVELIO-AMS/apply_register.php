...
if(isset($_POST['submit_app']) && $pdo){
    ...
    if($error === ''){
        ...
        if($id){
            echo "<script>alert('Application submitted successfully! We will review your application and contact you soon.');window.location.href='index.php';</script>";
            exit;
        }else{
        ...
        <div class="registration-container">
            ...
            <div class="text-center mt-6">
                <p class="text-muted text-sm">
                    Need help? Contact us at <a href="mailto:admissions@ejmnhs.edu.ph">admissions@ejmnhs.edu.ph</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateGradeLevels(department) {
                ...
                if (department === 'JHS') {
                    ['Grade 7', 'Grade 8', 'Grade 9', 'Grade 10'].forEach(grade => {
            ...
            document.getElementById('sameAddress').addEventListener('change', function() {
                if (this.checked) {
                    document.getElementById('perm_house_street').value = document.getElementById('curr_house_street').value;
                    document.getElementById('perm_barangay').value = document.getElementById('curr_barangay').value;
                    document.getElementById('perm_city').value = document.getElementById('curr_city').value;
                    document.getElementById('perm_province').value = document.getElementById('curr_province').value;
                    document.getElementById('perm_zip').value = document.getElementById('curr_zip').value;
                }
            });
            ...
            function populateReview() {
                ...
                document.getElementById('review-mobile').textContent = getValue('mobile');
                document.getElementById('review-email').textContent = getValue('email');
                
                document.getElementById('review-current_address').textContent = 
                    `${getValue('curr_house_street')}, ${getValue('curr_barangay')}, ${getValue('curr_city')}, ${getValue('curr_province')} ${getValue('curr_zip')}`;
                document.getElementById('review-permanent_address').textContent = 
                    `${getValue('perm_house_street')}, ${getValue('perm_barangay')}, ${getValue('perm_city')}, ${getValue('perm_province')} ${getValue('perm_zip')}`;
