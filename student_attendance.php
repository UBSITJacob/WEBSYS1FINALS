                ...
                <div class="card-body">
                    <form method="get" class="d-flex gap-4 flex-wrap" style="align-items: flex-end;">
                        <div class="form-group" style="margin-bottom: 0; min-width: 140px;">
                            ...
                            <input type="number" name="year" class="form-control" min="2000" max="2100" step="1" value="<?php echo (int)$year; ?>" required>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach($rows as $r): 
                                    ...
                                    $time = isset($r['recorded_at']) ? date('h:i A', strtotime($r['recorded_at'])) : '';
