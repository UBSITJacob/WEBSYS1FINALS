...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo $base_path; ?>/subjects.php" class="nav-item <?php echo $current_page === 'subjects.php' ? 'active' : ''; ?>">
                <span class="nav-item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
            ...
            <a href="<?php echo $base_path; ?>/admins.php" class="nav-item <?php echo $current_page === 'admins.php' ? 'active' : ''; ?>">
                <span class="nav-item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="nav-section">
            ...
            <a href="failed_students.php" class="nav-item <?php echo $current_page === 'failed_students.php' ? 'active' : ''; ?>">
                <span class="nav-item-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <span class="nav-item-text">Failed Students</span>
            </a>
            </div>
