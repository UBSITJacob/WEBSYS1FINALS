                    ...
                    <div class="form-row-2">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="d-flex gap-2">
                                <input type="date" id="date" class="form-control" value="<?php echo htmlspecialchars($date, ENT_QUOTES, 'UTF-8'); ?>">
                                <button type="button" class="btn btn-accent" onclick="applyDate()">
...
function applyDate(){ selectLoad(); }
document.getElementById('date').addEventListener('keydown', function(e){ if(e.key==='Enter'){ e.preventDefault(); applyDate(); }});
