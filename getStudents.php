...
$grade = $_GET['grade'] ?? '';
$dept = $_GET['dept'] ?? '';
$rows = $pdo->getStudents($q,$page,$limit,$sort,$dir,$grade,$dept);
$total = $pdo->countStudents($q,$grade,$dept);
        ...
        <tr>
            ...
            <td>
                <div class="table-actions">
                    <button onclick="viewStudent(<?php echo (int)$r['id']; ?>)" class="btn btn-sm btn-secondary" title="View Details">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
                        </svg>
                    </button>
                    <button onclick="updateStudent(<?php echo (int)$r['id']; ?>)" class="btn btn-sm btn-accent" title="Update Details">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                        </svg>
                    </button>
                    <button onclick="deleteStudent(<?php echo (int)$r['id']; ?>)" class="btn btn-sm btn-danger" title="Delete Student">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="3 6 5 6 21 6"></polyline>
                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                        </svg>
                    </button>
                    <?php if(!$r['has_account']): ?>
