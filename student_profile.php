            ...
            <div class="grid-2" style="margin-top: var(--spacing-6);">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-row" style="margin-bottom: var(--spacing-4);">
                            <div>
                                <label class="form-label text-muted text-sm">Name</label>
                                <div class="font-medium">
                                    <?php 
                                    $mother_name = trim(($s['mother_first_name'] ?? '').' '.($s['mother_middle_name'] ?? '').' '.($s['mother_last_name'] ?? ''));
                                    echo htmlspecialchars($mother_name ?: 'N/A', ENT_QUOTES, 'UTF-8'); 
                                    ?>
                                </div>
                            </div>
                            <div>
                                <label class="form-label text-muted text-sm">Contact</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['mother_contact'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div>
                                <label class="form-label text-muted text-sm">Occupation</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['mother_occupation'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                            <div>
                                <label class="form-label text-muted text-sm">Address</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['mother_address'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-row" style="margin-bottom: var(--spacing-4);">
                            <div>
                                ...
                                <div class="font-medium">
                                    <?php 
                                    $father_name = trim(($s['father_first_name'] ?? '').' '.($s['father_middle_name'] ?? '').' '.($s['father_last_name'] ?? ''));
                                    echo htmlspecialchars($father_name ?: 'N/A', ENT_QUOTES, 'UTF-8'); 
                                    ?>
                                </div>
                            </div>
                            <div>
                                <label class="form-label text-muted text-sm">Contact</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['father_contact'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div>
                                <label class="form-label text-muted text-sm">Occupation</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['father_occupation'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                            <div>
                                <label class="form-label text-muted text-sm">Address</label>
                                <div class="font-medium"><?php echo htmlspecialchars($s['father_address'] ?? 'N/A', ENT_QUOTES, 'UTF-8'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
