...
// Query all sections, ordered by grade level and section letter/name
$sql = "
    SELECT 
        s.id AS sectionId,
        s.section_name AS sectionName,
        s.grade_level AS gradeLevel,
        s.section_letter AS sectionLetter,
        COALESCE(u.fullname, 'N/A') AS adviserName,
...
// Set the current academic year (Hardcoded for demo)
$current_academic_year = "2024-2025";
?>

<h2>Manage Sections</h2>

<!-- Search bar - Keep for future consistency -->
...
<script>
    ...
    /** Fetches students not yet enrolled who match the given grade level. */
    ...
    /** Renders checkboxes for unassigned students. */
    ...
    document.getElementById('enrollmentForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                // Reload section manager to reflect changes
                loadPage('manage_sections.php'); 
            });
            ...
            // Note: The page will reload/re-render, so this button state change is mostly for fallback
        }
    });
...
<style>
/* Basic styles for the modal overlay (reused from manage_students.php for consistency) */
.modal-overlay {
...
.inner-student-table th, .inner-student-table td {
    padding: 8px;
